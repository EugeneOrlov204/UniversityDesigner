...
import 'package:hackathon_project/services/database.dart';
import 'package:hackathon_project/utils/sharedpref_helper.dart';
import 'package:hackathon_project/views/signin.dart';
...
class _HomeState extends State<Home> {
  ...
  Widget chatRoomsList() {
    return StreamBuilder<QuerySnapshot>(
      stream: chatRoomsStream as Stream<QuerySnapshot<Object?>>?,
  ...
  Widget searchUsersList() {
    return StreamBuilder<QuerySnapshot>(
      stream: usersStream as Stream<QuerySnapshot<Object?>>?,
      builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
        return snapshot.hasData
            ? ListView.builder(
          itemCount: snapshot.data!.docs.length,
